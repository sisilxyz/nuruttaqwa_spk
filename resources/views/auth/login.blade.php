            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <img src="{{ asset('img/smkn.png') }}" style="margin: 1px ;width: 168px; align: center;">
                                    <h3 class="title" style="margin: 14px ;"> Sistem Pendukung Keputusan Pemilihan Jurusan SMK<h3>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
